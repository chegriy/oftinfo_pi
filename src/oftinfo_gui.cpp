...
OFTinfoBase::OFTinfoBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	this->Connect( wxID_ANY, wxEVT_TIMER, wxTimerEventHandler( OFTinfoBase::OnTimer ) );
}
...
OFTinfoBase::~OFTinfoBase()
{
	...
	m_buttonDistressRelay->Disconnect( wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler( OFTinfoBase::OnDistressRelay ), NULL, this );
  ...
  this->Disconnect(wxID_ANY, wxEVT_TIMER,
                      wxTimerEventHandler(OFTinfoBase::OnTimer));
}
