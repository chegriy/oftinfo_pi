...
class OFTinfoBase : public wxDialog
{
	...
	public:
		...
		wxTextCtrl* m_textCtrlUnloadAreaDistance1;
		...
		wxTextCtrl* m_textCtrlUnloadAreaDistance11;
		wxTextCtrl* m_textCtrlUnloadAreaHist1;
		wxTextCtrl* m_textCtrlUnloadAreaDistance2;
